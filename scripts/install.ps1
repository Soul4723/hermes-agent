...
$RepoUrlSsh = if ($env:HERMES_REPO_URL_SSH) { $env:HERMES_REPO_URL_SSH } else { "git@github.com:Soul4723/hermes-agent.git" }
$RepoUrlHttps = if ($env:HERMES_REPO_URL_HTTPS) { $env:HERMES_REPO_URL_HTTPS } else { "https://github.com/Soul4723/hermes-agent.git" }
$RepoArchiveBaseUrl = "https://github.com/Soul4723/hermes-agent"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/Soul4723/hermes-agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
